...
start_forward() {
  ...
  nohup kubectl port-forward "svc/$service" "$local_port:$remote_port" >"$RUNTIME_DIR/$name.log" 2>&1 &
...
echo
echo "Local URLs (open in browser):"
echo "Frontend: http://127.0.0.1:4200"
echo "Keycloak: http://127.0.0.1:8080"
echo "Gateway: http://127.0.0.1:8085"
echo "Identity: http://127.0.0.1:8087"
echo "Product: http://127.0.0.1:8088"
